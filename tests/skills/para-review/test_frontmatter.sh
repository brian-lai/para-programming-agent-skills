...
SKILL_MD="skills/para-review/SKILL.md"
...
[ "$name" = "para-review" ] && echo "PASS name=para-review" || { echo "FAIL name=$name"; fail=1; }
...
[ "$model" = "opus" ] && echo "PASS top-level model=opus" || { echo "FAIL model=$model"; fail=1; }
[ "$effort" = "high" ] && echo "PASS top-level effort=high" || { echo "FAIL effort=$effort"; fail=1; }
